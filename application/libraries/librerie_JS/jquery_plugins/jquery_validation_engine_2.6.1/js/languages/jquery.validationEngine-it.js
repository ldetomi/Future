        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    "regex": "none",
                    "alertText": "<strong>Obbligatorio</strong>",
                    "alertTextCheckboxMultiple": "° Selezionare un'opzione",
                    "alertTextCheckboxe": "° E' richiesta la selezione della casella",
                    "alertTextDateRange": "° Entrambi i campi dell'intervallo della data sono richiesti"
                },
                "requiredInFunction": { 
                ...
                "dateRange": {
                    "regex": "none",
                    "alertText": "* Intervallo di date ",
                    "alertText2": "non valido"
                },
                "dateTimeRange": {
                    "regex": "none",
                    "alertText": "* Intervallo di tempo ",
                    "alertText2": "non valido"
                },
                "length": {
                    "regex": "none",
                ...
                "maxSize": {
                    "regex": "none",
                    "alertText": "Al massimo ",
                    "alertText2": " caratteri"
                },
		        "groupRequired": {
                    "regex": "none",
                    "alertText": "° Compilare uno dei seguenti campi",
                    "alertTextCheckboxMultiple": "° Selezionare un'opzione",
                    "alertTextCheckboxe": "° E' richiesta la selezione della casella"
                },
                "min": {
                    "regex": "none",
                    "alertText": "Il valore minimo è "
                },
                "max": {
                    "regex": "none",
                    "alertText": "Il valore massimo è "
                },
                "past": {
                    "regex": "none",
                ...
                "maxCheckbox": {
                    "regex": "none",
                    "alertText": "° Selezionare al massimo",
                    "alertText2": " opzioni"
                },
                "minCheckbox": {
                    "regex": "none",
                ...
                "validate2fields": {
                    ...
                    "alertText": "° Inserire nome e cognome"
                },
                "noSpecialCharacters": {
                    "regex": /^[0-9a-zA-Z]+$/,
                ...
                "ajaxUserCall": {
                    ...
                    "alertText": "° Questo user ID è già stato utilizzato"
                },
                "ajaxNameCall": {
                    "file": "ajaxValidateFieldName",
