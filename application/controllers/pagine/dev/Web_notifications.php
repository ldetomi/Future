<?php
  ...
  class Web_notifications extends Private_Controller 
  {    
...
//print('Il mio profilo attuale &egrave; '.$this->elementi_comuni->getCurrentProfile().', la lingua scelta: '.$this->_main_config_data["language"].'<br>');      
      ...
      $this->load->view('pagine/dev/web_notifications/view_web_notifications',$this->_view_data); // nome del file di view, vedi esempi in controller gia' esistenti
    }
  }
?> 
