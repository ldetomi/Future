<?php
  ...
  class Form extends Private_Controller 
  {    
...
//print('Il mio profilo attuale &egrave; '.$this->elementi_comuni->getCurrentProfile().', la lingua scelta: '.$this->_main_config_data["language"].'<br>');      
      ...
      $this->load->view('pagine/dev/form/view_form',$this->_view_data); // nome del file di view, vedi esempi in controller gia' esistenti
    }
  }
?> 
