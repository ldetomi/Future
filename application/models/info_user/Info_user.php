...
3) Funzioni a disposizione:
   ...
   ---------------
      ...
      N.B.
         In caso non sia passato alcun array, viene caricato ilo dato contenuto nel file di configurazione alla chiave 'allowed_browsers'      
...
===================
   ...
   $config['info_user']=array('allowed_browsers'=>array('IE'=>7.0,'Firefox'=>3.0,'Chrome'=>4.0,'Safari'=>3.0,'Opera'=>9.80),
                              'db_enabled'=>false,
                              'db_group'=>'default',
   ...
   In cui:
      ...
      'allowed_browsers' => array di browsers ammessi, questo dato viene caricato solo se non viene passato alcun array alla funzione browser_check
...
class Info_user extends CI_Model 
{
   ...
   function browser_check($min_acceptable_release=array())
   {
      if(empty($min_acceptable_release))
      {
         $data=$this->config->item("info_user");
         $min_acceptable_release=$data['allowed_browsers'];
      }
...
//print($which_browser."<br>".$this_version."<br><br><br>");
      $this_version_arr=explode(".",$this_version);
//print_r($this_version_arr);
//print("<br><br><br>");
      $this_version=0;
...
//print("i: ".$i." tmp_val: ".$tmp_val." this_version: ".$this_version."<br>");
      }

      $eval_string="\$test_version=(".$this_version.$op.$which_version.");";
//print("<br>".$eval_string."<br>");
      eval($eval_string);
//print("<br>".$test_version."<br>");
//print($info_user['browser']."==".$which_browser." test: ".$test_version."<br>");
